...
/* harmony import */ var _consts_projects_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(635);
/* harmony import */ var _consts_projectDetails_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(852);
/* harmony import */ var _consts_techs_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(928);
...
const renderProjectDetail = (projectId, t2) => {
    const project = _consts_projects_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.find(p => p.id === projectId);
    const details = (0,_consts_projectDetails_js__WEBPACK_IMPORTED_MODULE_3__/* .getProjectDetails */ .ES)(projectId);
                ...
                <article class="project-detail__content">
                    ...
                    <div class="project-detail__meta">
                        <div class="project-detail__techs">
                            ${project.techs.map(tech => `<span class="project-detail__tech">${_consts_techs_js__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A[tech]}</span>`).join('')}
                        </div>
                    </div>
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((t, t2) => {
    ...
    const currentProject = currentHash ? _consts_projects_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.find(p => p.id === currentHash) : null;
