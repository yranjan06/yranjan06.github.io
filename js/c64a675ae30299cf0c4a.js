"use strict";
(self["webpackChunkportfolio"] = self["webpackChunkportfolio"] || []).push([[733],{
...
/* harmony export */ });
/* harmony import */ var _consts_blogPosts_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(369);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((t) => {
    const categories = (0,_consts_blogPosts_js__WEBPACK_IMPORTED_MODULE_0__/* .getAllCategories */ .QU)();
    const tags = (0,_consts_blogPosts_js__WEBPACK_IMPORTED_MODULE_0__/* .getAllTags */ .r)();

    const params = new URLSearchParams(window.location.search);
    const category = params.get('category');
    const tag = params.get('tag');

    let postsToRender = _consts_blogPosts_js__WEBPACK_IMPORTED_MODULE_0__/* .blogPosts */ .A5;
    if (category) {
        postsToRender = (0,_consts_blogPosts_js__WEBPACK_IMPORTED_MODULE_0__/* .getPostsByCategory */ .bG)(category);
    } else if (tag) {
        postsToRender = (0,_consts_blogPosts_js__WEBPACK_IMPORTED_MODULE_0__/* .getPostsByTag */ .Pf)(tag);
    }

    // Check if we're viewing a specific blog post
    const currentHash = window.location.hash.slice(1); // Remove the # character
    const currentPost = currentHash ? (0,_consts_blogPosts_js__WEBPACK_IMPORTED_MODULE_0__/* .getPostBySlug */ .N7)(currentHash) : null;
        ...
        <aside class="blog-sidebar">
            ...
            <div class="blog-sidebar__stats">
                <div class="blog-sidebar__stat">
                    ...
                    <span class="blog-sidebar__stat-value">${_consts_blogPosts_js__WEBPACK_IMPORTED_MODULE_0__/* .blogPosts */ .A5.length}</span>
                </div>
                <div class="blog-sidebar__stat">
