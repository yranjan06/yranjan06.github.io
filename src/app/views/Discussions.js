    ...
    return /*html*/ `
        <div class="discussion-page">
            ...
            <div class="discussion-page__techs">
                ${project.techs.map(tech => `<span class="discussion-page__tech">${techs[tech]}</span>`).join('')}
            </div>
